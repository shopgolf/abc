...
function CheckAuthentication()
{
	...
	// some kind of session validation here. Even something very simple as...
	 ...
	 return isset($_SESSION['CKFINDER']) && isset($_SESSION['CKFINDER']['IsAuthorized']) && $_SESSION['CKFINDER']['IsAuthorized'];
	...
	//return true;
// 	if($_SESSION['CKFINDER']['IsAuthorized']){
// 		return true;
// 	}else{
// 		return false;
// 	}
...
*/
$baseUrl = isset($_SESSION['CKFINDER']['baseUrl'])?$_SESSION['CKFINDER']['baseUrl']:"";
...
$baseDir = isset($_SESSION['CKFINDER']['baseDir'])?$_SESSION['CKFINDER']['baseDir']:"";

/*
 * ### Advanced Settings
 */

$config = isset($_SESSION['CKFINDER'])?$_SESSION['CKFINDER']:"";
