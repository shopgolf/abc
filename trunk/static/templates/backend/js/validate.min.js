...
(function(q,r,m){var s={required:"%s field is required.",matches:"%s field does not match the %s field.","default":"%s field is still set to default, please change.",valid_email:"%s field must contain a valid email address.",valid_emails:"%s field must contain all valid email addresses.",min_length:"%s field must be at least %s characters in length.",max_length:"%s field must not exceed %s characters in length.",exact_length:"%s field must be exactly %s characters in length.",
greater_than:"%s field must contain a number greater than %s.",less_than:"%s field must contain a number less than %s.",alpha:"%s field must only contain alphabetical characters.",alpha_numeric:"%s field must only contain alpha-numeric characters.",alpha_dash:"%s field must only contain alpha-numeric characters, underscores, and dashes.",numeric:"%s field must contain only numbers.",integer:"%s field must contain an integer.",decimal:"%s field must contain a decimal number.",
is_natural:"%s field must contain only positive numbers.",is_natural_no_zero:"%s field must contain a number greater than zero.",valid_ip:"%s field must contain a valid IP.",valid_base64:"%s field must contain a base64 string.",valid_credit_card:"%s field must contain a valid credit card number.",is_file_type:"%s field must contain only %s files.",valid_url:"%s field must contain a valid URL."},t=function(a){},u=/^(.+?)\[(.+)\]$/,h=/^[0-9]+$/,v=/^\-?[0-9]+$/,k=/^\-?[0-9]*\.?[0-9]+$/,
