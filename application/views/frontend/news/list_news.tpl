            ...
            <div class="column col-xs-12 col-sm-3" id="left_column">
                                ...
                                <ul class="blog-list-sidebar clearfix">
                                    <li>
                                        <div class="post-thumb">
                                            <a href="#"><img src="{{$static_ft}}/data/blog-thumb1.jpg" alt="Blog"></a>
                                        </div>
                                        <div class="post-info">
                                    ...
                                    <li>
                                        <div class="post-thumb">
                                            <a href="#"><img src="{{$static_ft}}/data/blog-thumb2.jpg" alt="Blog"></a>
                                        </div>
                                        <div class="post-info">
                                            <h5 class="entry_title"><a href="#">Lorem ipsum dolor sit amet</a></h5>
                                            <div class="post-meta">
                                    ...
                                    <li>
                                        <div class="post-thumb">
                                            <a href="#"><img src="{{$static_ft}}/data/blog-thumb3.jpg" alt="Blog"></a>
                                        </div>
                                        <div class="post-info">
                                            <h5 class="entry_title"><a href="#">Lorem ipsum dolor sit amet</a></h5>
                                            <div class="post-meta">
                ...
                <div class="block left-module">
                    <div class="banner-opacity">
                        <a href="#"><img src="{{$static_ft}}/data/slide-left.jpg" alt="ads-banner"></a>
                    </div>
                </div>
                <!-- ./Banner -->
                <!-- Recent Comments -->
                ...
                <div class="block left-module">
                    <div class="banner-opacity">
                        <a href="#"><img src="{{$static_ft}}/data/slide-left2.jpg" alt="ads-banner"></a>
                    </div>
                </div>
                <!-- ./Banner -->
            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-5">
                                    <div class="entry-thumb image-hover2">
                                        <a href="#">
                                            <img src="{{$static_ft}}/images/blog-6.jpg" alt="Blog">
                                        </a>
                                    </div>
                                </div>
                                <div class="col-sm-7">
