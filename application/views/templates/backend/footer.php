 <!-- /.content-wrapper -->
    ...
    <!-- jQuery 2.1.4 -->
    <script src="<?php echo STATIC_BK; ?>js/jQuery-2.1.4.min.js"></script>
    <!-- Bootstrap 3.3.2 JS -->
    <script src="<?php echo STATIC_BK; ?>js/bootstrap.min.js" type="text/javascript"></script>
    <!-- AdminLTE App -->
    <script src="<?php echo STATIC_BK; ?>js/app.min.js" type="text/javascript"></script>
