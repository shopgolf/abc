                    ...
                    <ul class="nav navbar-nav">
                                    ...
                                    <ul class="menu">
                                        <li>
                                            ...
                                            <a href="#">
                                                <div class="pull-left">
                                                    <!-- User Image -->
                                                    <img src="<?php echo STATIC_BK,'/images/user3-128x128.jpg'?>" class="img-circle" alt="User Image" />
                                                </div>
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <img src="<?php echo STATIC_BK,'/images/user3-128x128.jpg'?>" class="user-image" alt="User Image" />
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu">
                    <li class="header">WITHGONEGOLF.COM</li>
