...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<?php echo $static->STATIC_BK.'/css/bootstrap.min.css';?>" />
        <link href="<?php echo base_url().'third_party/datatables/css/dataTables.bootstrap.css';?> " rel="stylesheet" type="text/css">
        <link href="<?php echo $static->STATIC_BK.'/css/AdminLTE.min.css';?>" rel="stylesheet" type="text/css">
        <link href="<?php echo $static->STATIC_BK.'/css/skin-blue.min.css';?>" rel="stylesheet" type="text/css">
        <link href="<?php echo $static->STATIC_BK.'/js/iCheck/flat/blue.css';?>" rel="stylesheet" type="text/css">
