...
CKFinder.lang['vi'] =
{
	...
	// Basket
	BasketFolder		: 'Basket',
	BasketClear			: 'Dọn basket',
	BasketRemove		: 'Xóa khỏi basket',
	BasketOpenFolder	: 'Mở thư mục cha',
	BasketTruncateConfirm : 'Bạn có chắc muốn bỏ tất cả tập tin trong basket?',
	BasketRemoveConfirm	: 'Bạn có chắc muốn bỏ tập tin "%1" khỏi basket?',
	BasketRemoveConfirmMultiple	: 'Do you really want to remove %1 files from the basket?', // MISSING
	BasketEmpty			: 'Không có tập tin trong basket, hãy kéo và thả tập tin vào basket.',
	BasketCopyFilesHere	: 'Chép tập tin từ basket',
	BasketMoveFilesHere	: 'Chuyển tập tin từ basket',
