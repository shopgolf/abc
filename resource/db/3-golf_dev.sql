...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 23, 2015 at 06:37 PM
...
INSERT INTO `configuration` (`id`, `title`, `keyword`, `description`, `logo`, `address`, `phone`, `email`, `fax`, `facebook`) VALUES
(3, 'gweagewgw', 'gwagawgwea', 'wagwagwa', '11e88ee9fd8a754b861d34127c911e6e.jpeg', NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `px_category` (`id`, `name`, `description`, `keyword`, `owner`, `lastupdated`) VALUES
(4, 'PUMA', 'PUMA', 'PUMA', 1, 1437660327),
(5, 'YAMAHA', 'YAMAHAYAMAHA', 'YAMAHA', 1, 1437660426),
(6, 'IN LOGO LÊN BÓNG', 'IN LOGO LÊN BÓNG', 'IN LOGO LÊN BÓNG', 1, 1437660478);
