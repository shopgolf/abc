...
var photos = [ {
		...
		"cssclass" : "cam",
		"css_li":"bachvu",
		"image" : "bg_slide_1.png" 
	}, {
		"title" : "Kiếm Thánh",
		"cssclass" : "clouds",
		"css_li":"kiemthanh",
		"image" : "bg_slide_2.png" 
	}, {
		"title" : "Thần Y",
		"cssclass" : "key",
		"css_li":"thany",
		"image" : "bg_slide_3.png" 
	}, {
		"title" : "Đao Hoàng",
		"cssclass" : "dh",
		"css_li":"daohoang",
		"image" : "bg_slide_4.png" 
	}
];
...
$(function() {
	...
	$.template("navboxTemplate", "<div class='navbox ${cssclass}'><ul></ul></div>");
	...
	$(".navbox:not(:eq(" + activeIndex +"))").css('left', '-9999px');
	
	// Set the proper background image, based on the active index
	$("<div />")
		.css({ 'background' : "url(images/" + photos[activeIndex].image + ") no-repeat center top" } )
	...
	var slideBackgroundPhoto = function(imageIndex) {
		...
		$("<div />")
			.css(
				{ 	'left' : '-2000px',
					'background' : "url(images/" + photo.image + ") no-repeat center top" } )
